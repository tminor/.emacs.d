...
(use-package org-pomodoro 
  ...
  :init
    ...
    (defun pomodoro-change-background ()
      (setq default-bg-color (face-attribute 'mode-line :background))
      (set-face-attribute 'mode-line nil :background "#028e4b")
      (sit-for 10)
      (set-face-attribute 'mode-line nil :background default-bg-color))
